...
letraFGesture.addDirection(fp.Finger.Thumb, fp.FingerDirection.VerticalUp, 1.0);
...
letraFGesture.addCurl(fp.Finger.Index, fp.FingerCurl.HalfCurl, 0.5);
...
letraFGesture.setWeight(fp.Finger.Thumb, 2);
letraFGesture.setWeight(fp.Finger.Index, 2);
